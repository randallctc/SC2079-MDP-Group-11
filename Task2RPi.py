...
def main():
    ...
    stable_buffer = deque(maxlen=5)  # recent detections
    required_stability = 2  # consecutive same detections before confirming
        ...
        while True:
            ...
            try:
                ...
                if data:
                    ...
                    # Check if class_id stable enough
                    if len(stable_buffer) >= required_stability and all(
                        ...
                        if (
                            class_id != last_detected_class
                            or (current_time - last_detection_time) >= cooldown_period
                        ):
                            if class_id == "None":
                                pass
